...
% preview(vid);
 ...
 img=imread('a (3).jpg');          %Reading an image file
...
bwn=~bwn;
bwn=bwareaopen(bwn, 1000);             %removing black areas of area<1000
bwn=~bwn;
subplot(2,2,3)
imshow(bwn)
...
bwn = bwareaopen(bwn, 1000);          %removing white areas of area<3000
subplot(2,2,4)
imshow(bwn)
title('bwareaopen(<1000)');
